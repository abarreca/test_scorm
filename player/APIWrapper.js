...
function doLMSGetValue(name)
{
   ...
   else
   {
      ...
      else
      {
         ...
         console.log('doLMSGetValue: ' + name + ' : ' + strValue);
         return strValue;
      }
   }
}
...
function doLMSSetValue(name, value)
{
   ...
   else
   {
      ...
      {
         console.log('doLMSSetValue: ' + name + ' : ' + value);
      }
   }
...
/*******************************************************************************
**
** Function isLMSImplement(name)
** Inputs:  name - string representing the cmi data model defined category or
**             element (e.g. cmi.core.student_id)
** Return:  true/false or undefined in case the API is unavailable
**
** Description:
** This function tries getting value of the data model element and check the 
** error code to see if it is implemented
**
*******************************************************************************/
function isLMSImplement(name)
{
	...
	if (api)
	{
		api.LMSGetValue(name);
		if (api.LMSGetLastError() == _NotImplementedError)
			return false;
		else
			return true;
	}
